...
#define     DEF_MAX_MCBZA_BDCHCNT          13
...
#define     DEF_AUXADC_VDC_RNG_MAX		51.2 // 102.4
#define     DEF_AUXADC_VDC_RNG_MIN		-51.2
#define 	DEF_AUXADC_VDC_RNG_FACTOR    ((DEF_AUXADC_VDC_RNG_MAX - DEF_AUXADC_VDC_RNG_MIN) / 16777216.0) //24bit
#define     DEF_AUXADC_VDC_RNG_RMAX		50.0 

#define     DEF_AUXADC_VAC_RNG_MAX		DEF_ADC_VAC_RNG_MAX // tmp
#define     DEF_AUXADC_VAC_RNG_MIN		DEF_ADC_VAC_RNG_MIN
#define 	DEF_AUXADC_VAC_RNG_FACTOR   DEF_ADC_VAC_RNG_FACTOR
#define     DEF_AUXADC_VAC_RNG_RMAX		DEF_ADC_VAC_RNG_RMAX
...
typedef struct   // 
{
	...
	st_zimaux_iacgain		iac_gain[4][DEF_MAX_IAC_RNGCNT];
