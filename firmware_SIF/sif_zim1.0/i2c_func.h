...
#include "lpc32xx_lib/lpc32xx_i2c.h"
...
#define  EEP_RANGEINFO_ADDR     0x1000
#define  EEP_CHECKROM_ADDR      0x0FF0
...
// I2C EEPROM Write delay time.	
#define DEF_I2CWR_MSDELAY  6 //5ms over
...
/* Close the I2C */
INT_32 i2c_close(INT_32 devid);

/* I2C configuration block */
INT_32 i2c_ioctl(INT_32 devid,
                 INT_32 cmd,
                 INT_32 arg);
