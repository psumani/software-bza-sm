...
{	
	...
	st_zim_eis_zdata			zdata_vac[DEF_MAX_AUX_VACCNT];
	st_zim_eis_zdata			zdata;
	st_zim_eis_raw_adc 			raw_adc[DEF_MAX_AUX_VACCNT][MAX_EIS_RAW_POINT];	
	st_zim_eis_raw_val 			raw_val[DEF_MAX_AUX_VACCNT][MAX_EIS_RAW_POINT];
} st_zim_eis_raw;   
