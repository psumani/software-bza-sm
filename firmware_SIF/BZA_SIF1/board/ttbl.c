 ...
 *                  |---------------------------|
 *                  |                           |
 *                  |  SDRAM RO  cached 16MB    |
 *      0x80FFFFFF  |                           |
 *      0x81000000  |---------------------------|
 *                  |                           |
 *                  |  SDRAM RO  No cached 16MB |
 *      0x81FFFFFF  |                           |
 *      0x82000000  |---------------------------|
 *                  |                           |
 *                  |  SDRAM RW  cached 16MB    |
 *      0x82FFFFFF  |                           |
 *      0x83000000  |---------------------------|
 *                  |                           |
 *                  |  SDRAM RW  No cached 16MB |
 *      0x83FFFFFF  |                           |
 *      0x84000000  |---------------------------|
 *
 *    $Revision: 40642 $
...
const TtSectionBlock_t TtSB[] =
{
  ...
  //   16 MB RO section cached (CODE)
  L1_SECTIONS_ENTRY(     16,0x80000000,0x80000000        ,2,0,1,0),
  //   16 MB RO section no cached (CODE)
  L1_SECTIONS_ENTRY(     16,0x81000000,0x81000000        ,2,0,0,0),
  //   16 MB WR section cached + write buffer (DATA)
  L1_SECTIONS_ENTRY(     16,0x82000000,0x82000000        ,3,1,1,1),
  //   16 MB WR section no cached (DATA)
  L1_SECTIONS_ENTRY(     16,0x83000000,0x83000000        ,3,1,0,0),
  TSB_INVALID,
