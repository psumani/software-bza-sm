...
extern "C"
{
	...
	#define ICE_CMD_EIS_SETPNTS			0x1A // needed data counts
	#define ICE_CMD_EIS_CFG				0x1B
	#define ICE_CMD_EIS_POINTS			0x1C // data counts that fpga got 
	...
	/* AUX Board command list */
	#define ICE_AUX_CMD_DDS_CLK				0x11
	#define ICE_AUX_CMD_ACADC_DEVICE		0x12
	#define ICE_AUX_CMD_V_ADC_VAL			0x15
	#define ICE_AUX_CMD_DEVICE_DO			0x18

	/* AUX Board device acadc cmd's const */
	#define ICE_AUX_CMD_VACADC_CTRL_OSR0		0x01
	#define ICE_AUX_CMD_VACADC_CTRL_OSR1		0x02
	#define ICE_AUX_CMD_VACADC_CTRL_FLT0		0x04
	#define ICE_AUX_CMD_VACADC_CTRL_FLT1		0x08
