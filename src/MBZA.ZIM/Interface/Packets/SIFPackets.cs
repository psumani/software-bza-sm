...
namespace ZiveLab.ZM.ZIM.Interface
{
    ...
    public struct stCmdHeader
    {
        ...
        public stCmdHeader(byte command, int slot)
        {
            Command = command;
            Slot = slot;
            Address = 0;
        ...
        public stCmdHeader(byte command, int slot, int address)
        {
            Command = command;
            Slot = slot;
            Address = address;
        ...
        public stCmdHeader(byte command, int slot, int address, int length)
        {
            Command = command;
            Slot = slot;
            Address = address;
