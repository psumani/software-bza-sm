//http://www.codeproject.com/Articles/17502/Simple-Popup-Control?fid=382337&df=90&mpp=25&noise=3&prof=False&sort=Position&view=Normal&spc=Relaxed&fr=51#xx0xx
...
namespace ZiveLab.Device.ZIM.Win.Controls
{
    /// <summary>
    ...
    [ToolboxItem(false)]
    public partial class PopupPanel : ToolStripDropDown
    {
        ...
        private PopupPanel _ownerPopup;
        private PopupPanel _childPopup;
        ...
        public PopupPanel(Control content)
        {
            if (content == null)
            {
        ...
        private void SetOwnerItem(Control control)
        {
            ...
            if (control is PopupPanel)
            {
                PopupPanel popupControl = control as PopupPanel;
