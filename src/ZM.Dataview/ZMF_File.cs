    ...
    class ZMF_File
    {
        ...
        public bool ReadHead(ref stResHeader head)
        {
            ...
            if (sVersion == "1.0.0.0")
            {
                ...
                head.sysInfo.mSIFCfg = hd1000.inf_sif;
                head.sysInfo.mZimCfg[0].info = hd1000.inf_sifch.info;
                head.sysInfo.mZimCfg[0].ranges[0].ID = hd1000.inf_sifch.ranges.ID;
                head.sysInfo.mZimCfg[0].ranges[0].iac_rng = hd1000.inf_sifch.ranges.iac_rng;
                head.sysInfo.mZimCfg[0].ranges[0].Idc_rnginf.Initialize();
                head.sysInfo.mZimCfg[0].ranges[0].mDummy = hd1000.inf_sifch.ranges.mDummy;
                head.sysInfo.mZimCfg[0].ranges[0].mEisIRngCalInfo = hd1000.inf_sifch.ranges.mEisIRngCalInfo;
                head.sysInfo.mZimCfg[0].ranges[0].mSafety = hd1000.inf_sifch.ranges.mSafety;
                head.sysInfo.mZimCfg[0].ranges[0].rtd_rng = hd1000.inf_sifch.ranges.rtd_rng;
                head.sysInfo.mZimCfg[0].ranges[0].vac_rng = hd1000.inf_sifch.ranges.vac_rng;
                head.sysInfo.mZimCfg[0].ranges[0].vdc_rng = hd1000.inf_sifch.ranges.vdc_rng;
                head.sysInfo.mZimCfg[0].ranges[1].Initialize(eZimType.UNKNOWN);
                head.sysInfo.mZimCfg[0].ranges[2].Initialize(eZimType.UNKNOWN);
                head.sysInfo.mZimCfg[0].ranges[3].Initialize(eZimType.UNKNOWN);
            ...
            else if (sVersion == "1.1.0.0")
            {
                ...
                head.sysInfo.mSIFCfg = hd1100.inf_sif;
                head.sysInfo.mZimCfg[0].info = hd1100.inf_sifch.info;
                head.sysInfo.mZimCfg[0].ranges[0].ID = hd1100.inf_sifch.ranges.ID;
                head.sysInfo.mZimCfg[0].ranges[0].iac_rng = hd1100.inf_sifch.ranges.iac_rng;
                head.sysInfo.mZimCfg[0].ranges[0].Idc_rnginf = hd1100.inf_sifch.ranges.Idc_rnginf;
                head.sysInfo.mZimCfg[0].ranges[0].mDummy = hd1100.inf_sifch.ranges.mDummy;
                head.sysInfo.mZimCfg[0].ranges[0].mEisIRngCalInfo = hd1100.inf_sifch.ranges.mEisIRngCalInfo;
                head.sysInfo.mZimCfg[0].ranges[0].mSafety = hd1100.inf_sifch.ranges.mSafety;
                head.sysInfo.mZimCfg[0].ranges[0].rtd_rng = hd1100.inf_sifch.ranges.rtd_rng;
                head.sysInfo.mZimCfg[0].ranges[0].vac_rng = hd1100.inf_sifch.ranges.vac_rng;
                head.sysInfo.mZimCfg[0].ranges[0].vdc_rng = hd1100.inf_sifch.ranges.vdc_rng;
                head.sysInfo.mZimCfg[0].ranges[1].Initialize(eZimType.UNKNOWN);
                head.sysInfo.mZimCfg[0].ranges[2].Initialize(eZimType.UNKNOWN);
                head.sysInfo.mZimCfg[0].ranges[3].Initialize(eZimType.UNKNOWN);
