...
namespace ZiveLab.ZM.Dataview
{
    public partial class GeneralGraphForm : Form    
    {
        ...
        {
           "Test time","Log(Frequency)","Zreal","AuxZre","Eref","AuxVdc","I","Temperature","Load","AuxLoad","Power","AuxPower","Capacity","Energy","AuxEnergy","Cycle time","Step time","LogI","Frequency"
        };
        
        private static string[] Y1AxesString = new string[]
        {
           "Zreal","AuxZreal","-Zim","-AuxZim","|Z|","|AuxZ|","Z-Phase","AuxZ-Phase","Log|Z|","Eref","AuxVdc","I","Temperature","Load","AuxLoad","Power","AuxPower","Capacity","Energy","AuxEnergy","LogI","Eoc"
        };

        private static string[] YOtherAxesString = new string[]
        {
           "None","Zreal","AuxZreal","-Zim","-AuxZim","|Z|","|AuxZ|","Z-Phase","AuxZ-Phase","Log|Z|","Eref","AuxVdc","I","Temperature","Load","AuxLoad","Power","AuxPower","Capacity","Energy","AuxEnergy","LogI","Eoc"
        };
