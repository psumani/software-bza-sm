...
namespace WriteLargeExcelFileEfficiently
{
    ...
    public class OpenXmlWriterHelper
    {
        ...
        private Stylesheet CreateStylesheet()
        {
            ...
            patternFill.ForegroundColor.Rgb = HexBinaryValue.FromString("bec1c4");
            ...
            Alignment alig1 = new Alignment();
            alig1.Vertical = VerticalAlignmentValues.Center;
            alig1.Horizontal = HorizontalAlignmentValues.Center;

            Alignment alig2 = new Alignment();
            alig2.Vertical = VerticalAlignmentValues.Center;
            alig2.Horizontal = HorizontalAlignmentValues.Center;
        ...
        public void WriteCellValueSax(OpenXmlWriter writer, string cellValue, CellValues dataType, uint styleIndex = 0, List<OpenXmlAttribute> attributes = null)
        {
            switch (dataType)
            {
                ...
                default:
                    {
                        if (attributes == null)
                        {
                            writer.WriteStartElement(new Cell() { DataType = dataType, StyleIndex = styleIndex });
                        }
                        else
                        {
                            writer.WriteStartElement(new Cell() { DataType = dataType , StyleIndex = styleIndex }, attributes);
                        }
                        writer.WriteElement(new CellValue(cellValue));
